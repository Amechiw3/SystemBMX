        ...
        <div class="row">
          <div class="col-xs-6">
            <form method="POST">
              <div class="form-group row">
                <div class="col-10">
                  <input type="text" class="form-control" onKeyPress="return soloLetras(event);" name="nomUsu" placeholder="<?php if($_SESSION['idioma'] == "English") {echo "Search category";} else {echo "Buscar por nombre";} ?>">
                </div>
                <div class="col-2">
                  <button class="btn btn-default" name="btnsearch" type="submit"><?php if($_SESSION['idioma'] == "English") {echo "Search";} else {echo "Buscar";} ?></button>
                </div>
              </div>
            </form>
          </div>
          <div class="col-xs-6">
            <div class="text-xs-right">
              <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseNuevo" aria-expanded="false" aria-controls="collapseNuevo"><?php if($_SESSION['idioma'] == "English") {echo "Add Categories";} else {echo "Agregar Categorias";} ?> <i class="fa fa-plus"></i></button>
            </div>
          </div>    
        </div><br>
        <div class="row">
              ...
              <div class="card card-block card-inverse" style="background-color: #333; border-color: #333;">
                <?php
                  if (isset($_POST["btnGuardarNuevo"])) 
                  {
                    ...
                    if ($crud->createCategorias($categoria)) 
                    {
                ...
                <form method="POST">
                  <div class="form-group row"><!-- categoria -->
                    ...
                    <div class="col-10">
                      <input class="form-control" onKeyPress="return soloLetras(event);" type="text" value="" id="categoria" name="categoria" required>
                    </div>
                  </div>
                  <hr>
                  <div class="form-group row">
