              ...
              {?>
                <table class="table table-hover table-inverse">
                  <?php
                    ...
                    $crud->dataviewVentaReporteSumariosUsuarios($query);
                  ?>
                </table>
                <?php
              }
              ...
              {?>
                <table class="table table-hover table-inverse">
                  <?php
                    ...
                    $crud->dataviewVentaReporteSumariosVentas($query);
                  ?>
                </table>
                <?php
              }
                ...
                <table class="table table-hover table-inverse">
                  <?php
                    $query = "SELECT
                      ...
                      INNER JOIN productos ON detventas.idproducto = productos.idproducto
                      INNER JOIN catproductos ON productos.idcatproducto = catproductos.idcatproducto";
                    $crud->dataviewVentaReporteSumariosCategoria($query);
                  ?>
                </table>
                <?php
              }
                ...
                <table class="table table-hover table-inverse">
                  <?php
                    $query = "SELECT
                      ...
                      INNER JOIN productos ON detventas.idproducto = productos.idproducto
                      INNER JOIN catproductos ON productos.idcatproducto = catproductos.idcatproducto";
                    $crud->dataviewVentaReporteSumariosProductos($query);
                  ?>
                </table>
                <?php
              }
